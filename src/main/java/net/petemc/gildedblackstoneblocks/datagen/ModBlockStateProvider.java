...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        axisBlock(((RotatedPillarBlock) ModBlocks.POLISHED_CHISELED_GILDED_BLACKSTONE.get()), blockTexture(ModBlocks.POLISHED_CHISELED_GILDED_BLACKSTONE.get()),
                ResourceLocation.fromNamespaceAndPath(GildedBlackstoneBlocks.MOD_ID, "block/polished_chiseled_gilded_blackstone_top"));
        blockItem(ModBlocks.POLISHED_CHISELED_GILDED_BLACKSTONE);
    }
